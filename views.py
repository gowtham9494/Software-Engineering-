...
def mechanicsclick_view(request):
    if request.user.is_authenticated:
        return HttpResponseRedirect('afterlogin')
    return render(request,'service/mechanicsclick.html')
...
def mechanic_signup_view(request):
    ...
    return render(request,'service/mechanicsignup.html',context=mydict)
...
def afterlogin_view(request):
    if is_customer(request.user):
        ...
        if accountapproval:
            ...
            return render(request,'service/mechanic_wait_for_approval.html')
    else:
...
def admin_mechanic_view(request):
    return render(request,'service/admin_mechanic.html')


@login_required(login_url='adminlogin')
def admin_approve_mechanic_view(request):
    mechanics=models.Mechanic.objects.all().filter(status=False)
    return render(request,'service/admin_approve_mechanic.html',{'mechanics':mechanics})
...
def approve_mechanic_view(request,pk):
    ...
    return render(request,'service/admin_approve_mechanic_details.html',{'mechanicSalary':mechanicSalary})
...
def admin_add_mechanic_view(request):
    ...
    return render(request,'service/admin_add_mechanic.html',context=mydict)


@login_required(login_url='adminlogin')
def admin_view_mechanic_view(request):
    mechanics=models.Mechanic.objects.all()
    return render(request,'service/admin_view_mechanic.html',{'mechanics':mechanics})
...
def update_mechanic_view(request,pk):
    ...
    if request.method=='POST':
        ...
        if userForm.is_valid() and mechanicForm.is_valid():
            ...
            mechanicForm.save()
            return redirect('admin-view-mechanic')
    return render(request,'service/update_mechanic.html',context=mydict)

@login_required(login_url='adminlogin')
def admin_view_mechanic_salary_view(request):
    mechanics=models.Mechanic.objects.all()
    return render(request,'service/admin_view_mechanic_salary.html',{'mechanics':mechanics})
...
def admin_mechanic_attendance_view(request):
    return render(request,'service/admin_mechanic_attendance.html')
...
def admin_take_attendance_view(request):
    ...
    if request.method=='POST':
        ...
        if form.is_valid():
            ...
            print('form invalid')
    return render(request,'service/admin_take_attendance.html',{'mechanics':mechanics,'aform':aform})
...
def mechanic_dashboard_view(request):
    ...
    return render(request,'service/mechanic_dashboard.html',context=dict)
...
def mechanic_work_assigned_view(request):
    ...
    return render(request,'service/mechanic_work_assigned.html',{'works':works,'mechanic':mechanic})
...
def mechanic_update_status_view(request,pk):
    ...
    return render(request,'service/mechanic_update_status.html',{'updateStatus':updateStatus,'mechanic':mechanic})
...
def mechanic_attendance_view(request):
    ...
    return render(request,'service/mechanic_view_attendance.html',{'attendaces':attendaces,'mechanic':mechanic})
...
def mechanic_feedback_view(request):
    ...
    if request.method=='POST':
        ...
        if feedback.is_valid():
            ...
            print("form is invalid")
        return render(request,'service/feedback_sent.html',{'mechanic':mechanic})
    return render(request,'service/mechanic_feedback.html',{'feedback':feedback,'mechanic':mechanic})
...
def mechanic_salary_view(request):
    ...
    return render(request,'service/mechanic_salary.html',{'workdone':workdone,'mechanic':mechanic})

@login_required(login_url='mechaniclogin')
@user_passes_test(is_mechanic)
def mechanic_profile_view(request):
    mechanic=models.Mechanic.objects.get(user_id=request.user.id)
    return render(request,'service/mechanic_profile.html',{'mechanic':mechanic})
...
def edit_mechanic_profile_view(request):
    ...
    return render(request,'service/edit_mechanic_profile.html',context=mydict)
