...
class RequestForm(forms.ModelForm):
    class Meta:
        ...
        fields=['category','service_no','service_name','service_model','service_brand','problem_description']
        widgets = {
...
class AdminRequestForm(forms.Form):
    ...
    mechanic=forms.ModelChoiceField(queryset=models.Mechanic.objects.all(),empty_label="Professional Name",to_field_name='id')
