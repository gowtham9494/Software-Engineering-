...
urlpatterns = [
    ...
    path('mechaniclogin', LoginView.as_view(template_name='service/mechaniclogin.html'),name='mechaniclogin'),
    ...
    path('customer-invoice/', views.customer_invoice, name='customer_invoice'),
    path('customer-invoice-payment/', views.customer_invoice_payment, name='customer_invoice_payment'),
