...
class Request(models.Model):
    cat=(('Women Salon, Spa & Laser Clinic','Women Salon, Spa & Laser Clinic'),('Men Salon & Massage','Men Salon & Massage'),('AC & Appliance Repair','AC & Appliance Repair'),('Cleaning & Pest Control','Cleaning & Pest Control'),('Electrician, Plumber & Carpenter','Electrician, Plumber & Carpenter'),('Native Water Purifier','Native Water Purifier'),('Native Smart Locks','Native Smart Locks'),('Painting, Waterproofing & Wall Panels','Painting, Waterproofing & Wall Panels'))
